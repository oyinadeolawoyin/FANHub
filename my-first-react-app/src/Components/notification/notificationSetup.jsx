      ...
      try {
        ...
        const subscription = await registration.pushManager.subscribe({
          ...
          applicationServerKey: urlBase64ToUint8Array(
            "BH2ABzwqDGV-NFDX-JoUM1tDr1YdisxsMB4FTFbBcJpmTjggtRAKkj6oswgdOQBSEax1YdCsAcu7l_Gmbc2e76A"
          )
        });
        ...
        await fetch("https://fanhub-server.onrender.com/api/notifications/save-subscription", {
          method: "POST",
